...
import '../../home/widgets/address_tile.dart';
...
class _StatusBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color = switch (state) {
      OrderState.completed => AppColors.success,
      OrderState.canceled => AppColors.error,
      _ => AppColors.primary,
    };
    final label = switch (state) {
      OrderState.completed => StatusConstants.completed,
      OrderState.canceled => StatusConstants.cancelled,
      OrderState.pending => StatusConstants.pending,
      OrderState.inProgress => StatusConstants.accepted,
      null => StatusConstants.pending,
    };
    final icon = switch (state) {
      OrderState.completed => AppSvgs.checkCircle,
      OrderState.canceled => AppSvgs.cancel,
      _ => AppSvgs.order,
    };
