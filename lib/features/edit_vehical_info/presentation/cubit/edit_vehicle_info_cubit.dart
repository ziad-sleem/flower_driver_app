...
import 'package:tracking_app/features/edit_vehical_info/domain/usecases/get_vehicles_use_case.dart';
import 'package:tracking_app/features/edit_vehical_info/domain/usecases/update_vehicle_use_case.dart';
...
class EditVehicleInfoCubit extends Cubit<EditVehicleInfoState> {
  ...
  Future<void> loadVehicles() async {
    ...
    switch (response) {
      case SuccessBaseResponse<VehiclesResponseEntity>():
        emit(
          state.copyWith(
      ...
      case ErrorBaseResponse<VehiclesResponseEntity>():
        emit(
          state.copyWith(
            isLoadingVehicles: false,
